...
wikiserver:~# tar cfz /root/dokuwikidata.tgz /srv/www/htdocs/dokuwiki/data/
wikiserver:~# scp dokuwikidata.tgz nagios1:
...
root@nagios1:~# cd /omd/sites/siteB/var/dokuwiki/
root@nagios1:# mv data dataORIG
root@nagios1:# tar xfz /root/dokuwikidata1.tgz
root@nagios1:# chown -R siteB.siteB data
...
root@nagios1:~# tar xfz arctic-mbo_2011-01-09.tgz -C /omd/sites/siteB/share/dokuwiki/htdocs/lib/tpl
...
root@nagios1:~# rm /opt/omd/sites/siteB/version/share/dokuwiki/htdocs/lib/plugins/plugin/disabled
...
vim /opt/omd/versions/0.46/share/dokuwiki/htdocs/lib/tpl/arctic-mbo/arctic_layout.css
...
OMD[siteB]:~$ htpasswd /opt/omd/sites/siteB/etc/htpasswd sepp
New password:
...
OMD[siteB]:~$ omd stop
OMD[siteB]:~$ omd config

{% endhighlight %}

Über den Punkt “DOKUWIKI_AUTH” gelangen Sie in ein neues Fenster:

![](/assets/import-dokuwiki-omd/omdconfigsiteB.png)
...
root@nagios2:/opt/omd/sites/siteB/etc# ls -la htpasswd*
-rw-r--r-- 1 siteB siteB 42 2011-06-15 08:43 htpasswd
root@nagios2:/opt/omd/sites/siteB/etc# omd config siteB
...
[enable Dokuwiki for user management]
...
root@nagios2:/opt/omd/sites/siteB/etc# ls -la htpasswd*
lrwxrwxrwx 1 siteB siteB 23 2011-06-15 09:39 htpasswd -> dokuwiki/users.auth.php
