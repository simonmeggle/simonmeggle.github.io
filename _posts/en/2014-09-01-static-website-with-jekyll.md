...
- [serve a static website with *CloudFront*](http://sylvain.durand.tf/site-statique-avec-cloudfront/) in order to get excellent performances and handle huge increases in workload;
