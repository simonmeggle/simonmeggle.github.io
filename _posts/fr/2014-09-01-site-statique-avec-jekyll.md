...
- [servir un site statique à l'aide de *CloudFront*](http://sylvain.durand.tf/site-statique-avec-cloudfront/) pour obtenir des performances maximales en termes de disponibilité et de vitesse ;
